...
class TtHEventInfoBranches {
  public:
    ...
    double btagsfMed_;
    double btagsfMed_bcUp_;
    double btagsfMed_bcDown_;
    double btagsfMed_lUp_;
    double btagsfMed_lDown_;
    double btagsfZ_;
    double btagsfZ_bcUp_;
    double btagsfZ_bcDown_;
    double btagsfZ_lUp_;
    double btagsfZ_lDown_;
    double btagsfLoose_;
    double btagsfLoose_bcUp_;
    double btagsfLoose_bcDown_;
    double btagsfLoose_lUp_;
    double btagsfLoose_lDown_;
    double mtprime_;
    double mjjExtrajj_;
    double mtprimeDummy_;
    double mtprimeDummyA_;
    double mtprimeDummyC_;
    double mtprime_corr_;
    double mtprimeDummy_corr_;
    double mtprimeDummyA_corr_;
    double mtprimeDummyC_corr_;
    double ht_ ; 
    int    nAK4_;
    int    nAK8_;
    int    nEl_;
    ...
    void RegisterTree(TTree* cutTree, std::string name="SelectedEvents") {
      ...
      cutTree->Branch((name+"_hltdecision").c_str(), &hltdecision_, (name+"_hltdecision/I").c_str()) ; 
      cutTree->Branch((name+"_hltdecisionBG").c_str(), &hltdecisionBG_, (name+"_hltdecisionBG/I").c_str()) ; 
      cutTree->Branch((name+"_hltdecisionH").c_str(), &hltdecisionH_, (name+"_hltdecisionH/I").c_str()) ; 
      ...
      cutTree->Branch((name+"_btagsfMed").c_str(), &btagsfMed_, "btagsfMed/D");
      cutTree->Branch((name+"_btagsfMed_bcUp").c_str(), &btagsfMed_bcUp_, "btagsfMed_bcUp/D");
      cutTree->Branch((name+"_btagsfMed_bcDown").c_str(), &btagsfMed_bcDown_, "btagsfMed_bcDown/D");
      cutTree->Branch((name+"_btagsfMed_lUp").c_str(), &btagsfMed_lUp_, "btagsfMed_lUp/D");
      cutTree->Branch((name+"_btagsfMed_lDown").c_str(), &btagsfMed_lDown_, "btagsfMed_lDown/D");
      cutTree->Branch((name+"_btagsfZ").c_str(), &btagsfZ_, "btagsfZ/D");
      cutTree->Branch((name+"_btagsfZ_bcUp").c_str(), &btagsfZ_bcUp_, "btagsfZ_bcUp/D");
      cutTree->Branch((name+"_btagsfZ_bcDown").c_str(), &btagsfZ_bcDown_, "btagsfZ_bcDown/D");
      cutTree->Branch((name+"_btagsfZ_lUp").c_str(), &btagsfZ_lUp_, "btagsfZ_lUp/D");
      cutTree->Branch((name+"_btagsfZ_lDown").c_str(), &btagsfZ_lDown_, "btagsfZ_lDown/D");
      cutTree->Branch((name+"_btagsfLoose").c_str(), &btagsfLoose_, "btagsfLoose/D");
      cutTree->Branch((name+"_btagsfLoose_bcUp").c_str(), &btagsfLoose_bcUp_, "btagsfLoose_bcUp/D");
      cutTree->Branch((name+"_btagsfLoose_bcDown").c_str(), &btagsfLoose_bcDown_, "btagsfLoose_bcDown/D");
      cutTree->Branch((name+"_btagsfLoose_lUp").c_str(), &btagsfLoose_lUp_, "btagsfLoose_lUp/D");
      cutTree->Branch((name+"_btagsfLoose_lDown").c_str(), &btagsfLoose_lDown_, "btagsfLoose_lDown/D");
      cutTree->Branch((name+"_mtprime").c_str(), &mtprime_, "mtprime/D");
      cutTree->Branch((name+"_mjjExtrajj").c_str(), &mjjExtrajj_, "mjjExtrajj/D");
      ...
      cutTree->Branch((name+"_mtprime_corr").c_str(), &mtprime_corr_, "mtprime_corr/D");
      cutTree->Branch((name+"_mtprimeDummy_corr").c_str(), &mtprimeDummy_corr_, "mtprimeDummy_corr/D");
      cutTree->Branch((name+"_mtprimeDummyA_corr").c_str(), &mtprimeDummyA_corr_, "mtprimeDummyA_corr/D");
      cutTree->Branch((name+"_mtprimeDummyC_corr").c_str(), &mtprimeDummyC_corr_, "mtprimeDummyC_corr/D");
      ...
      cutTree->Branch((name+"_isRegionA_Z").c_str(), &isRegionA_Z_, "isRegionA_Z/O");
      cutTree->Branch((name+"_isRegionB_Z").c_str(), &isRegionB_Z_, "isRegionB_Z/O");
      cutTree->Branch((name+"_isRegionC_Z").c_str(), &isRegionC_Z_, "isRegionC_Z/O");
      cutTree->Branch((name+"_isRegionD_Z").c_str(), &isRegionD_Z_, "isRegionD_Z/O");
      cutTree->Branch((name+"_isRegionNotABCD_Z").c_str(), &isRegionNotABCD_Z_, "isRegionNotABCD_Z/O");
      cutTree->Branch((name+"_lhewts").c_str(), &lhewts_) ;  
      cutTree->Branch((name+"_trigBit").c_str(), &trigBit_) ;  
      cutTree->Branch((name+"_trigName").c_str(), &trigName_) ;  
