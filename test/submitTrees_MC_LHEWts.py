...
def main():
    ...
    for ijob, job in enumerate(jobs) :
        ...
        #pyCfgParams = ['btageffmap='+effMap[job], 'applyBTagSFs=True','cleanEvents=True','isData=False','doPUReweightingOfficial=True','jecShift=0','jerShift=1', 'HTMin=0', 'storePreselEvts=True', 'storeLHEWts=False', 'storeTrigBits=False'] 
        pyCfgParams = ['btageffmap='+effMap[job],'applyBTagSFs=True','cleanEvents=False','isData=False','doPUReweightingOfficial=True','jecShift=0','jerShift=1', 'HTMin=0', 'storePreselEvts=True', 'storeLHEWts=True', 'storeTrigBits=False'] 
