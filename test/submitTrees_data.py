...
def main():
    ...
    config.JobType.pyCfgParams = ['cleanEvents=True','isData=True','doPUReweightingOfficial=False','jecShift=0','jerShift=0', 'HTMin=0', 'storePreselEvts=True','storeTrigBits=False'] 
